    ...
    if request.method == "POST":
        ...
        if article_post_form.is_valid():
            ...
            try:
                ...
                new_article.column = request.user.article_column.get(id=request.POST.get('column_id'))
                new_article.save()
                return HttpResponse("1")
            except Exception as e:
                print(e)
...
def article_detail(request,id,slug):
    ...
    return render(request, 'article/column/article_detail.html', dict(article=article))
...
def redit_article(request, article_id):
    if request.method == "GET":
        ...
        try:
            redit_article.column = request.user.article_column.get(id=request.POST.get("column_id"))
            redit_article.title = request.POST.get('title')
            redit_article.body = request.POST.get('body')
            redit_article.save()
            return HttpResponse("1")
        except:
            return HttpResponse("2")
